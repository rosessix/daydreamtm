...
export default function (props) {
    ...
    const validate = () => {
        if (signInMode) {
            ...
            _ax.post('/users/createuser', {
                ...
                setError('An error occurred. Please try inputting something else. If the issue persist, contact a developer.')
            })
        }
    ...
    return (
        <section className={`w-screen h-screen dark`} style={{ background: "linear-gradient(90deg, #667eea 0%, #764ba2 100%)" }}>
